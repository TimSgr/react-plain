...
return(
    <button className='overflow-hidden px-3.5 py-2 border-2 border-lightblue rounded-md m-1 relative group cursor-pointer font-medium text-lightblue text-white'>
